        ...
        <html>
            <div class="px-4 pt-5 my-5 text-center border-bottom">
                ...
                <div class="container px-5">
                    <img src="https://cdn.eraspace.com/media/catalog/product/i/p/ipad-8-wifi-gold-1_3.jpg" class="img-fluid border rounded-3 shadow-lg mb-4" alt="Example image" width="700" height="500" loading="lazy">
                </div>
                </div>
</html>
</html>
